...
# Bot information
SESSION = environ.get('SESSION', 'Auto Filter Bot')
API_ID = int(environ.get('API_ID', '34446649'))
API_HASH = environ.get('API_HASH', '8dc570c08d8e35e88fb9bfc73c65d7fa')
BOT_TOKEN = environ.get('BOT_TOKEN', "8758556768:AAHB4CWZuuYdlIpn2PcvZDAC9hsijwLMHBs")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://i.ibb.co/bjwFrTyy/7168219724-28773.jpg')).split()
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7892805795').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1003758676689') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1003515041061')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003791508617')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://anujedits:anujedits@cluster0.srnuyk3.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://i.ibb.co/tpDmH31k/7168219724-28145.jpg') # payment code picture url.
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'anuj_group_channel') # Support Chat Link Without https:// or @
